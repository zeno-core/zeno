...
pub fn scan_prefix_materialized_profiled(
    ...
    return engine_db.scan_prefix_materialized_profiled(db, allocator, prefix, shard_chunk_size);
}
...
pub fn scan_prefix_materialized_bulk_collect_profiled(
    ...
    return engine_db.scan_prefix_materialized_bulk_collect_profiled(db, allocator, prefix);
}
